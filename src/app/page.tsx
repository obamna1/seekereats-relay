      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <p className="text-sm text-gray-500">
            Square Integration Proof of Concept
          </p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-gray-600 mb-6">
            This proof of concept demonstrates how SeekerEats can integrate with
            restaurants that use Square as their point-of-sale system. We pull
            their menu directly from Square&apos;s Catalog API and create orders
            through Square&apos;s Orders API.
          </p>
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4 text-gray-600">
            <p>
              Right now, we&apos;re using a <strong>Seller Access Token</strong>{" "}
              from a test restaurant account. This token gives us direct access
              to that restaurant&apos;s Square data:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>Catalog API</strong> - Fetches the restaurant&apos;s
                menu items, prices, and images
              </li>
              <li>
                <strong>Orders API</strong> - Creates orders in the
                restaurant&apos;s Square Dashboard
              </li>
              <li>
                <strong>Payments API</strong> - Processes payments to the
            ...
            <p className="text-sm text-gray-500 mt-4">
              This proves we can display a real Square merchant&apos;s catalog
              and create real orders in their system.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4 text-gray-600">
            <p>
              With <strong>Square OAuth</strong>, any restaurant using Square
              can connect to SeekerEats with just a few clicks - no manual token
              sharing required.
            </p>
              ...
              <ol className="list-decimal list-inside space-y-3">
                <li>
                  ...
                  <p className="ml-6 text-sm">
                    They&apos;re redirected to Square&apos;s authorization page
                  </p>
                </li>
                <li>
                  <strong>Restaurant logs into their Square account</strong>
                  <p className="ml-6 text-sm">
                    Square shows what permissions SeekerEats is requesting
                  </p>
                </li>
                <li>
                  <strong>Restaurant approves the connection</strong>
                  <p className="ml-6 text-sm">
                    Square redirects back to SeekerEats with an authorization
                    code
                  </p>
                </li>
                <li>
                  <strong>
                    SeekerEats exchanges the code for access tokens
                  </strong>
                  <p className="ml-6 text-sm">
                    We securely store their tokens and can now access their
                    catalog
                  </p>
                </li>
              </ol>
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4 text-gray-600">
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              ...
              <div className="grid gap-2 text-sm">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    SeekerEats calls Square Catalog API{" "}
                    <span className="text-gray-500">(using seller token)</span>
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="bg-blue-600 text-white w-6 h-6 rounded-full flex items-center justify-center text-xs">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    Order appears in restaurant&apos;s Square Dashboard
                  </span>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-500">
              The key insight: by using the restaurant&apos;s access token, all
              API calls are made on behalf of that merchant. Their catalog,
              their orders, their payments.
            </p>
          </div>
        </section>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  We can pull and display any Square merchant&apos;s catalog
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  Orders appear in the restaurant&apos;s Square Dashboard
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  Payments go directly to the merchant&apos;s account
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  OAuth enables self-service restaurant onboarding
                </p>
              </div>
            </div>
          </div>
