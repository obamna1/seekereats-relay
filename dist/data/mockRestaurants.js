...
exports.MOCK_RESTAURANTS = void 0;
...
function getAllRestaurants() {
    return [...exports.MOCK_RESTAURANTS].sort((a, b) => (a.priority || 999) - (b.priority || 999));
}
/**
...
function getRestaurantById(id) {
    return exports.MOCK_RESTAURANTS.find((restaurant) => restaurant.id === id);
}
/**
...
function getRestaurantsByCuisine(cuisine) {
    return exports.MOCK_RESTAURANTS.filter((restaurant) => restaurant.cuisine.toLowerCase() === cuisine.toLowerCase());
}
//# sourceMappingURL=mockRestaurants.js.map